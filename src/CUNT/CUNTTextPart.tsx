      ...
      <div className="middle-section" style={{ maxWidth: "800px" }}>
        ...
        {language === "zh" ? (
          <p style={{ fontFamily: "HY Jin", fontSize: "16.2px", color: "var(--font-color-red)", transform: " rotate(60deg) translateX(-340px) translateY(-400px)", width: "200px", textAlign: "left", letterSpacing: "1.2px" }}>
            尺寸：<span style={{ fontFamily: "GT Alpina", fontSize: "17.8px" }}>6.4 × 11 inch</span><br />
              页数：<span style={{ fontFamily: "GT Alpina", fontSize: "17.8px" }}>86 </span>页<br />
            </p>
        ):(
            <p style={{ fontFamily: "GT Alpina", fontSize: "17.8px", color: "var(--font-color-red)", transform: " rotate(60deg) translateX(-340px) translateY(-400px)", width: "200px", textAlign: "left", letterSpacing: "1.2px" }}>
