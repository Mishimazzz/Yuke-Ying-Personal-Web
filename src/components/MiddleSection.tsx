  ...
  return(
    <div className="middle-section">
      <div className="Text-Container">
        ...
        <h4>installtion, 2023 summer</h4>

        <h3>CUNT Magazine</h3>
        <p>
          I have a cunt, I must receive!
        </p>
        <h4>publication, 2022 spring</h4>
        ...
        <h4>publication, 2022 winter</h4>

        <h3>nainai</h3>
        <p>
          No shame for your desire, nainai.
        </p>
        <h4>package, 2022 spring</h4>
      </div>
    </div>
  )
}
