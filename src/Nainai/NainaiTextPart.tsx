      ...
      <div className="middle-section" style={{ maxWidth: "800px" }}>
          ...
          >
            {language === "zh" ? (
              <p style={{ maxWidth: "430px", lineHeight: "27.3px", fontSize: "16.2px" }}>
                ...
                <br /><br />
                首期内容包括四篇专题文章（如性健康专家的知识普及、读者匿名投稿的性爱故事等），定期产品推荐、本地征友栏目，以及“<span style={{ fontFamily: "GT Alpina", fontSize: "17.8px" }}>nainai</span> 黄历”板块。我们借用报纸这一原始传播媒介，唤起人们对性的本能感知，尝试将中老年人性生活跳出黑箱。
                <br /><br />
                如报纸卷首语所言，<span style={{ fontFamily: "GT Alpina Italic", fontSize: "17.8px" }}>nainai</span> 旨在创造一个没有中央、没有异端审判、甚至没有姓名，只呼吁本能感受的言论竞技场。奶奶，你不必感到羞耻。
              </p>
            ) : (
        ...
        {language === "zh" ? (
          <p style={{ fontFamily: "HY Jin", fontSize: "16.2px", color: "var(--font-color-pink)", transform: " rotate(5deg) translateX(-445px) translateY(550px)", width: "250px", textAlign: "left", letterSpacing: "1.2px" }}>
            尺寸：<span style={{ fontFamily: "GT Alpina", fontSize: "17.8px" }}>340 × 486 mm</span><br />
            页数：<span style={{ fontFamily: "GT Alpina", fontSize: "17.8px" }}>4 </span>跨页<br />
        首刊由草蛇灰线出版小组发行。<br />
      </p>
      ) : (
            <p style={{ fontFamily: "GT Alpina", fontSize: "17.8px", color: "var(--font-color-pink)", transform: " rotate(5deg) translateX(-445px) translateY(550px)", width: "450px", textAlign: "left", letterSpacing: "1.2px" }}>
        Size: 340 × 486 mm<br />
