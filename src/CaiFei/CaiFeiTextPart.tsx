      ...
      <div className="middle-section" style={{ maxWidth: "800px" }}>
        <div className="text-box">
          <h3
            ...
            {language === "zh" ? (
              <>
                <span className="zh-font" style={{ fontFamily: "HY Jin", fontSize: "21.6px", display: "inline-block" }}>曹斐：潮汐宙合</span>
              </>
            ) : (
              "Cao Fei: Tidal Flux"
            )}
          ...
          >
            {language === "zh" ? (
              <p style={{ maxWidth: "430px", lineHeight: "27.3px", fontSize: "16.2px" }}>
                <br />
                “曹斐：潮汐宙合”展示了曹斐跨越近三十年的艺术实践。
                展览占据整个浦东美术馆二层空间，以“非线性”的叙事方式，
                呈现艺术家多元且广泛的作品。这场精彩的展览由南希·斯佩克特、
                谭雪及杨北辰共同策展，展陈由曹斐工作室和BEAU建筑事务所共同设计。
                我协助何翩翩与麦石工作室设计展览视觉，参与绘制三维环境中“扭曲”的字体系统、
                导视设计与制作（霓虹灯牌与投影灯）、时间墙设计与展签制作等。
              </p>
            ) : (
              <p style={{ maxWidth: "772px", lineHeight: "27.3px", fontSize: "17.8px" }}>
                <br />
                  <span style={{ fontFamily: "GT Alpina Italic", fontSize: "17.8px" }}>Cao Fei: Tidal Flux</span> offers a comprehensive overview of Cao Fei’s nearly thirty-year artistic journey. Occupying the museum’s entire second floor, the exhibition unfolds in a “non-linear” arrangement that animates her work through diverse perspectives. It is co-curated by Nancy Spector, Xue Tan, and Yang Beichen, with exhibition design by BEAU Architects.
                <br /><br />
        ...
        {language === "zh" ? (
          <p style={{ fontFamily: "HY Jin", fontSize: "16.2px", color: "var(--font-color-caofei)", transform: " rotate(-5deg) translateX(640px) translateY(-685px)", width: "400px", textAlign: "left" }}>
            客户：曹斐<br />
            设计：何翩翩与麦石设计工作室<br />
            设计助理：应凹凹<br />
          </p>
        ) : (
            <p style={{ fontFamily: "GT Alpina", fontSize: "17.8px", color: "var(--font-color-caofei)", transform: " rotate(-5deg) translateX(640px) translateY(-685px)", width: "400px", textAlign: "left" }}>
            Client: Cao Fei<br />
