      ...
      <div className="middle-section" style={{ maxWidth: "800px" }}>
        <div className="text-box">
          <h3
            ...
            {language === "zh" ? (<span className="zh-font" style={{ fontFamily: "HY Jin", fontSize: "19.2px", display: "inline-block" }}>规训档案</span>) : ("Discipline Archive")}
          </h3>
          <div className={`content ${isOpen ? "open" : ""} ${language === "zh" ? "zh-font" : ""}`}>
            {language === "zh" ? (
              <p style={{ maxWidth: "550px", lineHeight: "25px", fontSize: "14.5px" }}>
                ...
                <span style={{ fontFamily: "GT Alpina Italic", fontSize: "15.5px" }}> Discipline Archive </span>
        ...
        {language === "zh" ? (
          <p style={{ fontFamily: "HY Jin", fontSize: "16.2px", color: "var(--font-color-brown)", transform: " rotate(0deg) translateX(670px) translateY(-660px)", width: "250px", textAlign: "left", letterSpacing: "1.2px" }}>
            单张尺寸：<span style={{ fontFamily: "GT Alpina", fontSize: "15.5px" }}>300 × 420 mm</span><br />
            档案袋尺寸：<span style={{ fontFamily: "GT Alpina", fontSize: "15.5px" }}>350 × 500 mm</span><br />
            无再版印制。<br />
            由草蛇灰线出版小组发行。<br />
          </p>
        ) : (
            <p style={{ fontFamily: "GT Alpina", fontSize: "15.5px", color: "var(--font-color-brown)", transform: " rotate(0deg) translateX(670px) translateY(-660px)", width: "300px", textAlign: "left", letterSpacing: "1.2px" }}>
