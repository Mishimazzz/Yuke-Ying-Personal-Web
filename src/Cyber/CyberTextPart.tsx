      ...
      <div className="middle-section" style={{ maxWidth: "800px" }}>
        <div className="text-box">
          <h3
            ...
            {language === "zh" ? (
              <>
                <span className="zh-font" style={{ fontFamily: "HY Jin", fontSize: "21.6px", display: "inline-block" }}>二十一世纪的控制论</span>
              </>
            ) : (
