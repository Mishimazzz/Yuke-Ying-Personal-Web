      ...
      <div className="middle-section" style={{ maxWidth: "800px" }}>
        <div className="text-box">
          <h3
            ...
            {language === "zh" ? (<span className="zh-font" style={{ fontFamily: "HY Jin", fontSize: "19.2px", display: "inline-block" }}>止渴</span>) : ("Quench Thirst")}
          </h3>
          <div className={`content ${isOpen ? "open" : ""} ${language === "zh" ? "zh-font" : ""}`}>
            {language === "zh" ? (
              <p style={{ maxWidth: "550px", lineHeight: "25px", fontSize: "14.5px"}}>
                <br />
                在阅读何翔宇的《
                <span style={{ fontFamily: "GT Alpina Italic", fontSize: "15.5px" }}>Yellow Book</span>》后，我对他的“柠檬计划”及其背后的思考产生了浓厚兴趣。当我们试图观察一个对象，真正重要的从来不只是物质本身——其背后的历史，以及我们自身个体的经验，
                杂糅着塑造出它对我们而言的“本质”。
                <br /><br />
                出于对这一现象学探究的好奇，我创作了一本小刊物，并以中国古代成语“望梅止渴”为名。《止渴》以半透明的硫酸纸印制，无装帧，呈松散的卷轴状。黄色在纸张中若隐若现，暧昧地展示着事物本身
              ...
              <span style={{ fontFamily: "GT Alpina Italic", fontSize: "15.5px" }}> Yellow Book</span>, 
              I became intrigued by his 
              <span style={{ fontFamily: "GT Alpina Italic", fontSize: "15.5px" }}> Lemon Project</span>. 
              ...
              <span style={{ fontFamily: "GT Alpina Italic", fontSize: "15.5px" }}> Quench Thirst </span>
              is printed on 
